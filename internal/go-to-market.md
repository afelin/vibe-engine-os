...
> **Engineering-only.** Lives under `internal/` — not for public Pages / RISE mirrors. See [`README.md`](./README.md).
...
2. **One nocode post** — "Lovable → GitHub with receipts" using [Nocode Quickstart](../docs/nocode-quickstart.md).
3. **Solo guide as landing doc** — [Solo Vibe Coder Guide](../docs/solo-vibe-coder-guide.md) linked from README and issue template.
...
Run `npm run launch:scar` after [Launch Proof](../docs/launch-proof.md) passes. Replace placeholders with values from `.vibe/launch-proof.json`.
...
>
> See [Nocode Quickstart](../docs/nocode-quickstart.md).
